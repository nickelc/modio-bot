 ...
 * Ensure the bot has `Read Messages`, `Send Messages`, `Embed Links` and `Read Message History` permissions in the channel(s) it is in to be able to function correctly
